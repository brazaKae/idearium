...
function KareWindow({ title, w, h, children, x=0, y=0, position='absolute', tools=true }) {
  return (
    <div style={{
      ...
      background:'#FFF7E0', border:'2px solid #0A0A0A',
      boxShadow:'4px 4px 0 #0A0A0A',
      fontFamily:"'Pixelify Sans', monospace", color:'#0A0A0A',
      display:'flex', flexDirection:'column', overflow:'hidden',
    }}>
      <div style={{
        height:22, background:'#FFF7E0', borderBottom:'2px solid #0A0A0A',
        display:'flex', alignItems:'center', padding:'0 6px', gap:6,
        backgroundImage:`repeating-linear-gradient(0deg, #0A0A0A 0px, #0A0A0A 1px, transparent 1px, transparent 4px)`,
      }}>
        {tools && <div style={{width:14, height:14, border:'2px solid #0A0A0A', background:'#FFF7E0'}}/>}
        <div style={{
          flex:1, textAlign:'center', background:'#FFF7E0',
          fontSize:12, padding:'1px 8px', fontWeight:700,
          margin:'0 4px',
        }}>{title}</div>
        {tools && <>
          <div style={{width:14, height:14, border:'2px solid #0A0A0A', background:'#FFF7E0'}}/>
          <div style={{width:14, height:14, border:'2px solid #0A0A0A', background:'#0A0A0A'}}/>
        </>}
      </div>
...
function BootScreen() {
  return (
    <div style={{
      ...
      flexDirection:'column', gap:30, fontFamily:"'Pixelify Sans', monospace", color:'#FFF7E0',
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.06) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
      <Icon name="mac" scale={6} color="#FFF7E0" />
      <div style={{fontFamily:"'Workbench', monospace", fontSize:36, textShadow:'4px 4px 0 #000'}}>
        IDEARIUM
      </div>
      ...
      <div style={{
        width:300, height:14, border:'2px solid #FFF7E0',
        position:'relative', overflow:'hidden',
      }}>
        <div style={{
          width:'72%', height:'100%',
          background:`repeating-linear-gradient(90deg, #FFF7E0 0px, #FFF7E0 4px, transparent 4px, transparent 8px)`,
        }}/>
      </div>
...
function MenuBar() {
  return (
    <div style={{
      ...
      background:'#FFF7E0', borderBottom:'2px solid #0A0A0A',
      display:'flex', alignItems:'center', padding:'0 12px', gap:18,
      fontSize:13, color:'#0A0A0A', fontFamily:"'Pixelify Sans', monospace", zIndex:50,
    }}>
    ...
    <div style={{
      ...
      <KareWindow title="RFC-0011 — Enchentes urbanas e infra cinza" w={620} h={400} x={150} y={56}>
        <div style={{padding:'14px 18px', display:'grid', gridTemplateColumns:'1fr 180px', gap:14, height:'100%'}}>
          <div>
            <div style={{
              fontFamily:"'Workbench', monospace", fontSize:16, lineHeight:1.3,
          ...
          <div style={{display:'flex', flexDirection:'column', gap:6, fontSize:10}}>
            <div style={{background:'#0A0A0A', color:'#FFF7E0', padding:'3px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>METADADOS</div>
            <Row k="autor" v="m. brando"/>
            <Row k="lab" v="cidade"/>
            <Row k="status" v="discussão"/>
            <Row k="dias" v="14"/>
            <Row k="cartas" v="07"/>
            <div style={{marginTop:6, height:48, border:'1px solid #0A0A0A', position:'relative'}}>
              <svg width="100%" height="100%" viewBox="0 0 200 48" preserveAspectRatio="none">
                <path d="M 0 40 L 30 35 L 60 25 L 100 18 L 140 12 L 180 6 L 200 4" stroke="#0A0A0A" strokeWidth="2" fill="none"/>
              </svg>
      ...
      <KareWindow title="Lab.Cidade" w={420} h={280} x={780} y={86}>
        <div style={{padding:'10px 14px', height:'100%', display:'flex', flexDirection:'column', gap:6}}>
          <div style={{display:'flex', alignItems:'center', gap:10, paddingBottom:8, borderBottom:'1px dashed #0A0A0A'}}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              background: i===0 ? '#FFD43B' : 'transparent',
            }}>
        ...
        <div style={{padding:'10px 14px'}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:6}}>
            {['EM DISCUSSÃO','APROVADA','VETADA','URGENTE','REVER','ARQUIVADA'].map((s,i)=>(
              <div key={i} style={{
                border:'1px solid #0A0A0A', padding:'5px 4px', textAlign:'center',
                fontSize:9, background: i===0 ? '#0A0A0A' : '#FFF7E0',
                color: i===0 ? '#FFF7E0' : '#0A0A0A', fontWeight:700, cursor:'pointer',
              }}>{s}</div>
            ))}
          </div>
      ...
      <KareWindow title="Carta · Sem título" w={380} h={260} x={620} y={420}>
        <div style={{padding:'10px 14px', height:'100%'}}>
          ...
          <div style={{fontSize:10, opacity:0.6, marginBottom:8, paddingBottom:6, borderBottom:'1px dashed #0A0A0A'}}>resp: rfc-0011</div>
      ...
      <div style={{
        ...
        background:'#FFF7E0', border:'2px solid #0A0A0A', boxShadow:'4px 4px 0 #0A0A0A',
...
function Row({ k, v }) {
  return (
    <div style={{display:'flex', justifyContent:'space-between', borderBottom:'1px dotted #0A0A0A', paddingBottom:1, fontSize:10}}>
...
const btnStyle = (primary=false) => ({
  ...
  background: primary ? '#0A0A0A' : '#FFF7E0',
  color: primary ? '#FFF7E0' : '#0A0A0A',
  border:'2px solid #0A0A0A',
  fontFamily:"'Pixelify Sans', monospace", cursor:'pointer', fontWeight:700,
  boxShadow: primary ? '2px 2px 0 #FFD43B' : 'none',
});
...
function RFCWindow() {
  return (
    <div style={{
      width:'100%', height:'100%', background:'#3B82E0', padding:20,
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.18) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
      <KareWindow title="RFC-0011 — Enchentes urbanas e infra cinza" w="100%" h="100%" position="relative">
        <div style={{padding:'18px 22px', display:'grid', gridTemplateColumns:'1fr 220px', gap:18, height:'100%'}}>
          <div>
            <div style={{
              fontFamily:"'Workbench', monospace", fontSize:18, lineHeight:1.3,
            ...
            <div style={{
              ...
              padding:'4px 8px', display:'inline-block', background:'#FFD43B', border:'1px solid #0A0A0A',
            }}>
            ...
            <div style={{marginTop:14, padding:10, border:'1px solid #0A0A0A', background:'#FFFBEF'}}>
            ...
            <div style={{marginTop:14, padding:'8px 10px', borderLeft:'3px solid #0A0A0A', background:'#FFD43B', fontSize:12, fontStyle:'italic'}}>
          ...
          <div style={{display:'flex', flexDirection:'column', gap:8, fontSize:11}}>
            <div style={{background:'#0A0A0A', color:'#FFF7E0', padding:'4px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>METADADOS</div>
            <Row k="autor" v="m. brando"/>
            <Row k="lab" v="cidade"/>
            <Row k="status" v="discussão"/>
            ...
            <div style={{marginTop:8, padding:6, background:'#FFFBEF', border:'1px solid #0A0A0A'}}>
              ...
              <svg width="100%" height="40" viewBox="0 0 180 40" preserveAspectRatio="none">
                <path d="M 0 35 L 20 30 L 40 32 L 60 22 L 80 25 L 100 14 L 120 18 L 140 8 L 160 12 L 180 4" stroke="#0A0A0A" strokeWidth="2" fill="none"/>
                <path d="M 0 35 L 20 30 L 40 32 L 60 22 L 80 25 L 100 14 L 120 18 L 140 8 L 160 12 L 180 4 L 180 40 L 0 40 Z" fill="#0A0A0A" opacity="0.15"/>
              </svg>
...
function LabFinder() {
  const labs = [
    {name:'Lab.Cidade',    icon:'city',    n:22, members:14, color:'#0A0A0A'},
    {name:'Lab.Economia',  icon:'scale',   n:18, members:9,  color:'#0A0A0A'},
    {name:'Lab.Educação',  icon:'book',    n:14, members:11, color:'#0A0A0A'},
    {name:'Lab.Digital',   icon:'floppy',  n:11, members:7,  color:'#0A0A0A'},
    {name:'Lab.Cultura',   icon:'feather', n:9,  members:6,  color:'#0A0A0A'},
    {name:'Lab.Trabalho',  icon:'hand',    n:7,  members:8,  color:'#0A0A0A'},
  ];
  return (
    <div style={{
      width:'100%', height:'100%', background:'#3B82E0', padding:20,
      ...
      <KareWindow title="Lab Finder" w="100%" h="100%" position="relative">
        <div style={{padding:'14px 18px', height:'100%', display:'flex', flexDirection:'column'}}>
          <div style={{
            ...
            paddingBottom:8, borderBottom:'2px solid #0A0A0A',
          }}>
          ...
          <div style={{
            ...
            borderBottom:'1px dashed #0A0A0A', letterSpacing:'0.05em', opacity:0.6,
          }}>
          ...
          <div style={{marginTop:'auto', paddingTop:8, borderTop:'2px solid #0A0A0A', fontSize:10, display:'flex', justifyContent:'space-between'}}>
...
function StampDialog() {
  return (
    <div style={{
      width:'100%', height:'100%', background:'#3B82E0', padding:24,
      display:'flex', alignItems:'center', justifyContent:'center',
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.18) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
        ...
        <div style={{padding:'16px 20px', height:'100%', display:'flex', flexDirection:'column', gap:10}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:8}}>
            {[
              ...
              <div key={i} style={{
                border:'2px solid #0A0A0A', padding:'8px 10px',
                fontSize:11, fontWeight:700, letterSpacing:'0.05em',
                background: s.sel ? '#0A0A0A' : '#FFF7E0',
                color: s.sel ? '#FFF7E0' : '#0A0A0A', cursor:'pointer',
                display:'flex', alignItems:'center', gap:6,
              }}>
                <div style={{
                  width:10, height:10, border:`1.5px solid ${s.sel ? '#FFF7E0' : '#0A0A0A'}`,
                  background: s.sel ? '#FFD43B' : 'transparent',
                }}/>
                {s.l}
              </div>
            ))}
          ...
          <div style={{
            marginTop:6, padding:'6px 8px', background:'#FFD43B',
            border:'1px solid #0A0A0A', fontSize:10, lineHeight:1.4,
          }}>
    ...
    <div style={{
      ...
      <KareWindow title="Nova RFC · sem título.rfc" w="100%" h="100%" position="relative">
        <div style={{padding:'12px 16px', height:'100%', display:'flex', flexDirection:'column', gap:8}}>
          {/* Toolbar */}
          <div style={{display:'flex', gap:6, paddingBottom:8, borderBottom:'1px dashed #0A0A0A', flexWrap:'wrap'}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 180px', gap:12, flex:1, overflow:'hidden'}}>
            {/* Editor */}
            <div style={{background:'#FFFBEF', border:'1px solid #0A0A0A', padding:'12px 16px', overflow:'hidden'}}>
              <input style={{
                width:'100%', fontFamily:"'Workbench', monospace", fontSize:18,
                background:'transparent', border:'none', outline:'none', padding:0,
                letterSpacing:'-0.02em',
              }} defaultValue="RENDA.BÁSICA.exe"/>
              <div style={{borderBottom:'1px dashed #0A0A0A', paddingBottom:8, marginBottom:10}}>
                <input style={{
              ...
              <div style={{fontSize:13, lineHeight:1.6, color:'#0A0A0A'}}>
            ...
            <div style={{display:'flex', flexDirection:'column', gap:6, fontSize:10, overflow:'auto'}}>
              <div style={{background:'#0A0A0A', color:'#FFF7E0', padding:'3px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>RASCUNHO</div>
              <Row k="autor" v="você"/>
              ...
              <div style={{marginTop:6, padding:6, background:'#FFFBEF', border:'1px solid #0A0A0A'}}>
                ...
                {['título','3+ parágrafos','pelo menos 1 citação','tags','escolha de lab'].map((c,i)=>(
                  <div key={i} style={{display:'flex', gap:5, alignItems:'center', fontSize:9, marginBottom:2}}>
                    <span style={{
                      width:10, height:10, border:'1.5px solid #0A0A0A',
                      background: i<3 ? '#0A0A0A' : 'transparent',
                      color:'#FFD43B', fontSize:8, textAlign:'center', lineHeight:'7px',
                    }}>{i<3?'✓':''}</span>
                    {c}
                  </div>
                ))}
          ...
          <div style={{
            paddingTop:6, borderTop:'1px solid #0A0A0A',
    ...
    <div style={{
      ...
      <KareWindow title="Sobre o Idearium" w={380} h={340} position="relative" tools={false}>
        <div style={{padding:'18px 20px', height:'100%', display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', gap:8}}>
          ...
          <div style={{
            fontFamily:"'Workbench', monospace", fontSize:20,
          ...
          <div style={{
            ...
            paddingTop:10, borderTop:'1px dashed #0A0A0A', width:'100%',
          }}>
