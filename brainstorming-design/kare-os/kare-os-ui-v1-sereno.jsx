...
function KareWindow({ title, w, h, children, x=0, y=0, position='absolute', tools=true }) {
  return (
    <div style={{
      ...
      <div style={{
        height:22, background:'#FAFAF7', borderBottom:'2px solid #0A0A0A',
        ...
        {tools && <div style={{width:14, height:14, border:'2px solid #0A0A0A', background:'#FAFAF7'}}/>}
        <div style={{
          flex:1, textAlign:'center', background:'#FAFAF7',
          fontSize:12, padding:'1px 8px', fontWeight:700,
          margin:'0 4px',
        }}>{title}</div>
        {tools && <>
          <div style={{width:14, height:14, border:'2px solid #0A0A0A', background:'#FAFAF7'}}/>
...
function BootScreen() {
  return (
    <div style={{
      ...
      flexDirection:'column', gap:30, fontFamily:"'Pixelify Sans', monospace", color:'#FAFAF7',
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.06) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
      <Icon name="mac" scale={6} color="#FAFAF7" />
      <div style={{fontFamily:"'VT323', monospace", fontSize:36, textShadow:'4px 4px 0 #000'}}>
        IDEARIUM
      </div>
      ...
      <div style={{
        width:300, height:14, border:'2px solid #FAFAF7',
        position:'relative', overflow:'hidden',
      }}>
        <div style={{
          width:'72%', height:'100%',
          background:`repeating-linear-gradient(90deg, #FAFAF7 0px, #FAFAF7 4px, transparent 4px, transparent 8px)`,
        }}/>
      </div>
...
function MenuBar() {
  return (
    <div style={{
      ...
      background:'#FAFAF7', borderBottom:'2px solid #0A0A0A',
  ...
  return (
    <div style={{
      ...
      <KareWindow title="RFC-0011 — Enchentes urbanas e infra cinza" w={620} h={400} x={150} y={56}>
        <div style={{padding:'14px 18px', display:'grid', gridTemplateColumns:'1fr 180px', gap:14, height:'100%'}}>
          ...
          <div style={{display:'flex', flexDirection:'column', gap:6, fontSize:10}}>
            <div style={{background:'#0A0A0A', color:'#FAFAF7', padding:'3px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>METADADOS</div>
        ...
        <div style={{padding:'10px 14px', height:'100%', display:'flex', flexDirection:'column', gap:6}}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              background: i===0 ? '#C8A04A' : 'transparent',
            }}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:6}}>
            {['EM DISCUSSÃO','APROVADA','VETADA','URGENTE','REVER','ARQUIVADA'].map((s,i)=>(
              <div key={i} style={{
                ...
                fontSize:9, background: i===0 ? '#0A0A0A' : '#FAFAF7',
                color: i===0 ? '#FAFAF7' : '#0A0A0A', fontWeight:700, cursor:'pointer',
              }}>{s}</div>
            ))}
          </div>
      ...
      <div style={{
        ...
        background:'#FAFAF7', border:'2px solid #0A0A0A', boxShadow:'4px 4px 0 #0A0A0A',
...
const btnStyle = (primary=false) => ({
  ...
  background: primary ? '#0A0A0A' : '#FAFAF7',
  color: primary ? '#FAFAF7' : '#0A0A0A',
  border:'2px solid #0A0A0A',
  fontFamily:"'Pixelify Sans', monospace", cursor:'pointer', fontWeight:700,
  boxShadow: primary ? '2px 2px 0 #C8A04A' : 'none',
});
...
function RFCWindow() {
  return (
    <div style={{
      width:'100%', height:'100%', background:'#1E3A5F', padding:20,
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.18) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
        ...
        <div style={{padding:'18px 22px', display:'grid', gridTemplateColumns:'1fr 220px', gap:18, height:'100%'}}>
          <div>
            ...
            <div style={{
              ...
              padding:'4px 8px', display:'inline-block', background:'#C8A04A', border:'1px solid #0A0A0A',
            }}>
            ...
            <div style={{marginTop:14, padding:10, border:'1px solid #0A0A0A', background:'#F5F2EB'}}>
            ...
            <div style={{marginTop:14, padding:'8px 10px', borderLeft:'3px solid #0A0A0A', background:'#C8A04A', fontSize:12, fontStyle:'italic'}}>
          ...
          <div style={{display:'flex', flexDirection:'column', gap:8, fontSize:11}}>
            <div style={{background:'#0A0A0A', color:'#FAFAF7', padding:'4px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>METADADOS</div>
            <Row k="autor" v="m. brando"/>
            <Row k="lab" v="cidade"/>
            <Row k="status" v="discussão"/>
            ...
            <div style={{marginTop:8, padding:6, background:'#F5F2EB', border:'1px solid #0A0A0A'}}>
...
function StampDialog() {
  return (
    <div style={{
      width:'100%', height:'100%', background:'#1E3A5F', padding:24,
      display:'flex', alignItems:'center', justifyContent:'center',
      backgroundImage:`radial-gradient(circle at 1px 1px, rgba(255,247,224,0.18) 1px, transparent 0)`,
      backgroundSize:'4px 4px',
    }}>
      <KareWindow title="Aplicar Carimbo · RFC-0011" w={380} h={340} position="relative" tools={false}>
        <div style={{padding:'16px 20px', height:'100%', display:'flex', flexDirection:'column', gap:10}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:8}}>
            {[
              ...
              <div key={i} style={{
                ...
                background: s.sel ? '#0A0A0A' : '#FAFAF7',
                color: s.sel ? '#FAFAF7' : '#0A0A0A', cursor:'pointer',
                display:'flex', alignItems:'center', gap:6,
              }}>
                <div style={{
                  width:10, height:10, border:`1.5px solid ${s.sel ? '#FAFAF7' : '#0A0A0A'}`,
                  background: s.sel ? '#C8A04A' : 'transparent',
                }}/>
                {s.l}
              </div>
            ))}
          ...
          <div style={{
            marginTop:6, padding:'6px 8px', background:'#C8A04A',
      ...
      <KareWindow title="Nova RFC · sem título.rfc" w="100%" h="100%" position="relative">
        <div style={{padding:'12px 16px', height:'100%', display:'flex', flexDirection:'column', gap:8}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 180px', gap:12, flex:1, overflow:'hidden'}}>
            {/* Editor */}
            <div style={{background:'#F5F2EB', border:'1px solid #0A0A0A', padding:'12px 16px', overflow:'hidden'}}>
              <input style={{
            ...
            <div style={{display:'flex', flexDirection:'column', gap:6, fontSize:10, overflow:'auto'}}>
              <div style={{background:'#0A0A0A', color:'#FAFAF7', padding:'3px 6px', textAlign:'center', fontWeight:700, letterSpacing:'0.05em'}}>RASCUNHO</div>
              <Row k="autor" v="você"/>
              ...
              <div style={{marginTop:6, padding:6, background:'#F5F2EB', border:'1px solid #0A0A0A'}}>
                ...
                {['título','3+ parágrafos','pelo menos 1 citação','tags','escolha de lab'].map((c,i)=>(
                  <div key={i} style={{display:'flex', gap:5, alignItems:'center', fontSize:9, marginBottom:2}}>
                    <span style={{
                      ...
                      color:'#C8A04A', fontSize:8, textAlign:'center', lineHeight:'7px',
                    }}>{i<3?'✓':''}</span>
                    {c}
                  </div>
                ))}
